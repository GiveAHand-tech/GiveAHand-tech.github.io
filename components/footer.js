        ...
        <div class="container mx-auto px-6">
          <div class="py-12 text-center">
            ...
            <div class="max-w-md mx-auto">
              <a href="mailto:giveahandtech@gmail.com" class="inline-block bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-lg font-semibold transition duration-300 shadow">Email</a>
            </div>
          </div>
